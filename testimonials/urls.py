...
from .views import AllTestimonials, AddTestimonial, UpdateTestimonial, DeleteTestimonial
...
urlpatterns = [
    ...
    path("delete/<int:pk>", DeleteTestimonial.as_view(), name="delete_testimonial"),
]
